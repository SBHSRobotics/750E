...
#define I 600//525, 100 starting line drive

		pidMoveChassis(-I,I);
    pidSetTarget(iARM,-300);//-169 starting line drive
    wait10Msec(100);

		pidMoveChassis(2600,2600);
		wait10Msec(400);
		...
		pulseConveyor();
		pulseConveyor();
		while(true); //Ignore the error here for now. RobotC whines when it sees an empty loop.
