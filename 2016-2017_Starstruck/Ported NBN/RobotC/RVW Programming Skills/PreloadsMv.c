...
#pragma config(Sensor, I2C_1,  IME_BR,         sensorNone)
#pragma config(Sensor, I2C_2,  IME_FR,         sensorNone)
#pragma config(Sensor, I2C_3,  IME_BL,         sensorNone)
#pragma config(Sensor, I2C_4,  IME_FL,         sensorNone)
...
#pragma config(Motor,  port1,           W_FR,          tmotorVex393HighSpeed, openLoop)
#pragma config(Motor,  port2,           W_BR,          tmotorVex393HighSpeed, openLoop)
#pragma config(Motor,  port3,           W_FL,          tmotorVex393HighSpeed, openLoop)
#pragma config(Motor,  port4,           W_BL,          tmotorVex393HighSpeed, openLoop)
...
task main() {
 		...
 		pidSetTarget(iARM,-171);//Move arm up to tile shot position
 		move(-127,127,500);//Turn towards net
 		wait1Msec(100);
 		shooter(100);//Run shooter for first ball
 		motor[CON] = 127;//Start conveyor to spit out preload 1
 		wait1Msec(100);
 	  pidSetTarget(iARM,-275);
